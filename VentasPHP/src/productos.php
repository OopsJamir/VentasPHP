             ...
             <div class="modal-body">
                 <form action="" method="post" autocomplete="off">
                     ...
                     <div class="form-group">
                         ...
                         <input type="text" placeholder="Ingrese código de barras" name="codigo" id="codigo" class="form-control" oninput="validarCodigo(this)">
                         <script>
                        function validarCodigo(input) {
                        // Obtener el valor del campo de entrada de texto
                        var codigo = input.value;
                         // Eliminar cualquier caracter que sea una letra
                        codigo = codigo.replace(/[a-zA-Z]/g, '');
                         // Asignar el valor actualizado al campo de entrada de texto
                         input.value = codigo;
                            }
                        </script>
                     ...
                     <div class="form-group">
                         ...
                         <input type="text" placeholder="Ingrese nombre del producto" name="producto" id="producto" class="form-control" oninput="validarNombre(this)">
                         <script>
                        function validarNombre(input) {
                        // Obtener el valor del campo de entrada de texto
                        var nombre = input.value;
                        // Eliminar cualquier caracter que sea un número
                     ...
                     <div class="form-group">
                         ...
                         <input type="text" placeholder="Ingrese precio" class="form-control" name="precio" id="precio" class="form-control" oninput="validarCodigo(this)">
                     </div>
                     <div class="form-group">
                         <label for="cantidad">Cantidad</label>
                         <input type="number" placeholder="Ingrese cantidad" class="form-control" name="cantidad" id="cantidad" class="form-control" oninput="validarCodigo(this)">
                     </div>
