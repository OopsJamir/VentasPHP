            ...
            <div class="modal-body">
                <form method="post" id="frmPass">
                    <div class="form-group">
                        ...
                        <input id="actual" class="form-control" type="text" name="actual" placeholder="Clave actual" required>
                    </div>
                    <div class="form-group">
                        <label for="nueva"><i class="fas fa-key"></i> Contraseña Nueva</label>
                        <input id="nueva" class="form-control" type="text" name="nueva" placeholder="Clave nueva" required>
                    </div>
